...
export const NavbarLogo = () => {
  return (
    ...
    >
      ...
      />
      <div className="ml-1">
        <div className="text-xl font-bold text-blue-600">AppDost</div>
        <div className="text-[10px] text-blue-500 tracking-wide">
    ...
    <div className="relative w-full min-h-screen">
      ...
      <div className="container mx-auto px-4 pt-32">
        <div className="space-y-8 pb-20">
          <h1 className="text-4xl font-bold text-center">AppDost - Complete IT Solution</h1>
